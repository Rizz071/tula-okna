            ...
            <ArticlesContainer
                ...
                articles={[
...

                    {
                        ...
                        articleParagraphsJSX: [
                            <>
                                ГОСТ 30971 прямо требует, чтобы всегда монтажный
                                шов должен был трёхслойным: наружная
                                гидроизоляция, монтажной пены и внутренняя
                                пароизоляция.
                            </>,
                            <>
                                <strong>
                                    Мы всегда включаем в стоимость монтажа
                                    оконные мембраны или мастику.
                                </strong>
                            </>,
                            <>
