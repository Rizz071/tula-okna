...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: "https://тульские-окна.рф/",
    },
};
                ...
                articles={[
                    {
                        ...
                        articleParagraphsJSX: [
                            ...
                            <>
                                В собственных цехах был налажен полный
                                техпроцесс производства и сборки окон и дверей
                                из дерева, ПВХ и алюминия.
                            </>,
                        ],
                        articlesAccordion: [
                            {
                                accordionTitle: (
                                    <>
                                        ОКОННОЕ ПРОИЗВОДСТВО, КОТОРЫМ МЫ
                                        ГОРДИЛИСЬ
                                    </>
                                ),
                                accordionParagraphs: [
                                    <>
                                        Сначала мы изготавливали простые
                                        деревянные окна, потом &mdash;
                                        алюминиевые раздвижки, а затем
                                        добавилось производство окон и дверей
                                        ПВХ.
                                    </>,
                                    <>
                                        Позже у нас в ассортименте появился
                                        фасадный алюминий с окнами и входными
                                        группами.
                                    </>,
                                    <>
                                        Кроме того, у нас была организована
                                        сушка древесины в сушильной камере и
                                        линия по окраске оконных профилей ПВХ.
                                    </>,
                                ],
                            },
                        ],
                        articleMedia: {
                            ...
                            imageCaption: (
                                <>
                                    Мы долгое время сами производили окна и
                                    знаем как изготовить их хорошо
                                </>
                            ),
                            border: true,
                        },
...

                    {
                        ...
                        articleParagraphsJSX: [
                            <>
                                ...
                                иметь своё локальное производство стало не
                                выгодно.
                            </>,
                            <>
                                Мы тщательно выбирали среди лучших
                                производителей нашего региона, и с 2019 года
                                начали успешно работать с московскими ЗАО
                                ГЛАССПРОМ и АО СОФОС на партнёрских условиях.
                            </>,
                        ],
                        articlesAccordion: [
                            {
                                accordionTitle: (
                                    <>ПОЧЕМУ НЕ СОХРАНИЛИ СВОЁ ПРОИЗВОДСТВО?</>
                                ),
                                accordionParagraphs: [
                                    <>
                                        Большие оконные заводы предоcтавляют
                                        очень широкий ассортимент продукции.
                                        Там, где мы предлагали 3 вида окон,
                                        завод предлагал 10. Чем больше у нас
                                        вариантов продукции &mdash; тем больше
                                        проблем клиентов мы можем ею закрыть!
                                    </>,
                                    <>
                                        Кроме того, стоимость окон для конечного
                                        заказчика не меняется, потому что
                                        большие заводы получают материалы для
                                        своего производства по гораздо более
                                        низкой закупочной цене, чем мелкие
                                        локальные производители. На некоторые
                                        изделия цены у нас даже снизились!
                                    </>,
                                    <>
                                        Сейчас мы, как и раньше, проектируем
                                        окна и двери сами, а затем отправляем их
                                        в работу напрямую на автоматизированное
                                        производство нашего партнёра в Москву.
                                    </>,
                                    <>
                                        Там наш проект дополнительно проверяется
                                        технологами, а готовая продукция на
                                        выходе с завода проверяется отделом
                                        технического контроля.
                                    </>,
                                    <>
                                        Затем продукция проверяется при
                                        получении на Тульском распределительном
                                        центре (складе) и доставляется на наш
                                        склад, где уже мы сами проверяем всё ещё
                                        раз.
                                    </>,
                                ],
                            },
...

                    {
                        ...
                        articleParagraphsJSX: [
                            <>
                                ГОСТ 30971 прямо требует, чтобы монтажный шов
                                был трёхслойным: наружная гидроизоляция,
                                монтажная пена и внутренняя пароизоляция.
                            </>,
                            <>
                                <strong>
                                    Мы всегда выполняем требования ГОСТ к
                                    монтажному шву.
                                </strong>
                            </>,
                            <>
                                Искренне считаем, что любой монтаж должен
                                проводиться по ГОСТ и его нарушение &mdash;
                                прямой обман заказчика с целью предложить цену
                                дешевле остальных.
                            </>,
                        ],
                        articlesAccordion: [
                            {
                                accordionTitle: <>ЗАЧЕМ СОБЛЮДАТЬ ГОСТ?</>,
                                accordionParagraphs: [
                                    <>
                                        Со стороны улицы мы обязаны защитить
                                        монтажную пену от солнечных лучей и
                                        влаги, а изнутри &mdash; от влажного
                                        воздуха жилого помещения.
                                    </>,
                                    <>
                                        К сожалению, на оконном рынке
                                        распространена ситуация, когда окна
                                        устанавливаются на одну только пену. Это
                                        ложная экономия, так как позже приводит
                                        к значительным затратам на ремонт, не
                                        сопоставимым с ценой изолирующих
                                        монтажных лент или мастики.
                                    </>,
                                    <>
                                        Без защиты с улицы буквально через год
                                        пена желтеет и выкрашивается, а без
                                        защиты со стороны помещения пена
                                        начинает гнить и разрушаться внутри
                                        монтажного шва.
                                    </>,
                                    <>
                                        Бывают случаи, когда установка монтажных
                                        лент действительно не обязательна. Один
                                        из примеров &mdash; пароизоляция под
                                        тёплым откосом из пенополистирола,
                                        который сам имеет свойства пароизоляции.
                                    </>,
                                    <>
                                        Эти моменты выясняются при проведении
                                        замера и согласовываются с каждым
                                        клиетом индивидуально. В общем же случае
                                        отказываться от монтажа по ГОСТ ради
                                        экономии крайне опасно!
                                    </>,
                                ],
                            },
                        ],
                ...
                articles={[
                    {
                        ...
                        articleParagraphsJSX: [
                            ...
                            <>
                                <strong>
                                    Наша гарантия составляет: 3 года на изделия
                                    и 5 лет на монтажные работы.
                                </strong>{" "}
                            </>,
                            <>
                                Кроме того, мы работаем на рынке более{" "}
                                {new Date().getFullYear() - 1998} лет, не меняя
                                своего юридического лица и местоположения офиса
                                в Туле. Всё это время чествно отвечаем по взятым
                                на себя гарантийным обязательствам перед нашими
                                клиентами.
                            </>,
                        ],
                        articlesAccordion: [
                            {
                                accordionTitle: <>ЧТО ВХОДИТ В ГАРАНТИЮ?</>,
                                accordionParagraphs: [
                                    <>
                                        Гарантия распространяется на дефекты,
                                        связанные с механизмом фурнитуры,
                                        герметичностью стеклопакетов,
                                        стабильностью геометрии створок,
                                        работоспособностью уплотнителя,
                                    ...
                                    <>
                                        Наша бригада монтажников выезжает
                                        бесплатно по всем гарантийным случаям.
                                    </>,
                                    <>
                                        Кроме того, мы ведём учёт заказов,
                                        выполненных каждой бригадой, и по
                                        рекламации выезжает именно та бригада,
                                        которая устанавливала данный заказ.
                                    </>,
                                    <>
                                        Наши монтажники знают, что если что-то
                                        случится, то за свою работу будут
                                        отвечать именно они. Это сильно
                                        дисциплинирует и повышает уровень
                ...
                <Grid container columnSpacing={8} rowSpacing={10}>
                        ...
                        advantages={[
                            ...
                            },
                            {
                                ...
                                description: (
                                    <>
                                        <strong>
                                            Доставка спец&shy;транспор&shy;том
                                        </strong>
                                        . Надежное крепление и упаковка
                                        предотвращают повреждения изделий в
                                        дороге.
                                    </>
                                ),
                            },
                            {
                                ...
                                description: (
                                    <>
                                        Максимально точный расчет цены в течение
                                        1 дня. Перед подписанием договора Вы
                                        будете знать точную стоимость и
                                        детальную конфигурацию заказа.
                                    </>
                                ),
                            },
                            {
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <Typography variant="h2">
                            Установка окон пластиковых
                            <br />
                            &quot;под ключ&quot;
                        </Typography>
                        <Typography>
                            Для того чтобы заказать окна пластиковые в Туле и
                            тульской области в нашей организации, выполните
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        ...
                        <Typography>
                            Купить окна пластиковые в Туле для самостоятельной
                            установки возможно у нас. Необходимый порядок
                            действий:
                        </Typography>
