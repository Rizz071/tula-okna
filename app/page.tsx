                ...
                articles={[
                    {
                        ...
                        articleParagraphsJSX: [
                            ...
                            <>
                                ...
                                производства и сборки окон и дверей из дерева,
                                ПВХ и алюминия.
                            </>,
                        ],
                        articlesAccordion: [
                            {
                                accordionTitle: (
                                    <>ПРОИЗВОДСТВО, КОТОРЫМ МЫ ГОРДИЛИСЬ</>
                                ),
                                accordionParagraphs: [
                                    <>
                                        Сначала мы изготавливали изготавливали
                                        простые деревянные окна, потом
...

                    {
                        ...
                        articleParagraphsJSX: [
                            ...
                            <>
                                Мы тщательно выбирали среди крупных заводов, и с
                                2019 года начали работать с ЗАО ГЛАССПРОМ и АО
                        ...
                        articlesAccordion: [
                            {
                                ...
                                accordionParagraphs: [
                                    <>
                                        Крупные оконные заводы предоcтавляют
                                        очень широкий ассортимент продукции.
                                        Там, где мы предлагали 3 вида окон,
                                        завод предлагает 10. Мы, в свою очередь,
                                        предлагаем это нашим клиентам.
                                    </>,
                                    <>
                                        Кроме того, стоимость продукции для
                                        конечного заказчика не меняется, потому
                                        что большие заводы получают материалы
                                        для своего производства по гораздо более
