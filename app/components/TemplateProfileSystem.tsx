              ...
              <Table size="small" style={{ tableLayout: "fixed" }}>
                ...
                <TableBody>
                  <TableRow sx={{ verticalAlign: "top" }}>
                    <TableCell colSpan={2}>
                      {profilePage.recommendedUse.map((useCase, index) => {
                        return (
                          <Typography
                            sx={{
                              mx: {
                ...
                <TableCell colSpan={2}>
                  <Grid container sx={{ width: "100%" }}>
                    <Grid size={{ xs: 3 }}>
                      ...
                      >
                        <Image
                          src={profilePage.profileSystemLogo}
                  ...
                  return (
                    <TableRow key={index}>
                      <TableCell
                        sx={{
                          height: "3.0rem",
                          boxShadow: propertyTableLine.accent
