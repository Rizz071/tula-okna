  ...
  return (
    <Grid container columnSpacing={2}>
      <Grid size={12}>
        ...
        >
          Отправьте фотографию эскизов окон с приблизительными размерами
          проёмов, и мы пришлём расчёт в течение рабочего дня. Не будем
        ...
        <Box sx={{ width: "100%" }}>
          <StyledTextField
            ...
            onChange={() => {
              ...
              console.log("width: ", (() => fileRef.current?.offsetWidth)());
