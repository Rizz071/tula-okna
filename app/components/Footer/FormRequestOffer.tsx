...
const FormRequestOffer = () => {
    ...
    const handleSubmitSketch = async () => {
        reachMetrikaGoal("click_contacts"); // Вешаем обработчик события клика счётчика Метрики
    ...
    return (
        <Grid container columnSpacing={2}>
            <Grid size={12}>
                ...
                >
                    Отправьте фотографию эскизов окон с приблизительными
                    размерами проёмов, и мы пришлём расчёт в течение рабочего
                    дня. Не будем беспокоить голосовыми звонками!
                </Typography>
            </Grid>
                                    ...
                                    <InputAdornment position="start">
                                        ...
                                        {!files ? (
                                            ...
                                            <Typography
                                                sx={{
                                                    m: 0,
                                                    fontSize: "1rem", // Перенесли fontSize внутрь sx
                                                }}
                                            >
                                                &nbsp;
                                                {files.length} файла
