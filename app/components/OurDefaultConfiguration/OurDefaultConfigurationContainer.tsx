    ...
    return (
        <>
            ...
            <Typography sx={{ textAlign: "center" }}>
                ...
                всех наших заказов, и в 90% случаев переходит в итоговый
                договор. Каждая отдельная деталь &mdash; это результат
                тщательного отбора, который мы ведём более 20 лет.
            </Typography>
