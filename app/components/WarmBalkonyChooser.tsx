        ...
        >
              ...
              >
                <FormControl fullWidth variant="filled">
                  ...
                  <Select
                    ...
                    sx={{ pt: 1 }}
                  >
                    <MenuItem value={"0"}>Не будет</MenuItem>
          ...
          >
            {apartmentWindowsList.map(
              (
                { system_title, image, link, floor, street_noise, price },
                index,
              ) => {
                return (
                      ...
                      <TableContainer component={Paper} sx={{ width: "300px" }}>
                        <Table size="small">
                          ...
                          <TableBody>
                            <TableRow>
                              <TableCell>
                                <Tooltip arrow title={info_tooltip.option1}>
                                  <Stack
                                    direction="row"
                                    sx={{
                                      gap: 0.5,
                            ...
                            <TableRow>
                              <TableCell>
                                <Tooltip
                                  arrow
                                  title={info_tooltip.street_noise}
                                >
                                  <Stack
                                    direction="row"
                                    sx={{
