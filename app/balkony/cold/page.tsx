        ...
        articles={[
          {
            ...
            articleParagraphsJSX: [
              <>
                Раздвижные рамы системы &quot;ПРОВЕДАЛ&quot; &mdash;{" "}
                <strong>
                  наиболее экономичный на сегодняшний день вариант остекления
                  балкона или лоджии
                </strong>
                , а для старого балкона с ветхой несущей плитой &mdash; и
                единственно возможное решение, потому что пластиковые рамы будут
                слишком тяжелы.
              </>,
              <>
                Если стоит задача просто закрыть лоджию от осадков, звуков, пыли
                &mdash; целесообразно использовать именно раздвижную систему
                &quot;ПРОВЕДАЛ&quot;.
              </>,
              <>
                Холодное ограждение балконов понижает уровень теплопотерь и шума
                - шумоизоляция увеличивается.
              </>,
              <>
                По нашему опыту, монтаж раздвижек из профиля Provedal
                обеспечивает прекрасную защиту от пыли и осадков - на балконе
                постоянно будет сухо и чисто.
              </>,
            ],
            articlesAccordion: [],
            articleMedia: {
              ...
              imageCaption: (
                <>
                  Холодное остекление балкона с &quot;выносом рамы вперёд&quot;
                </>
              ),
              border: true,
            },
...

          {
            ...
            articleParagraphsJSX: [
              <>
                Профиль выпонен из специального сплава АД31 на основе алюминия,
                который стоек к осадкам и перепадам температур.
              </>,
              <>
                Рамы выпускаются белого и коричневого цвета, а также
                окрашиваются порошковым способом в любой цвет по палитре RAL.
              </>,
              <>
                <strong>
                  Раздвижные рамы системы &quot;ПРОВЕДАЛ&quot; - это лучшее
                  сочетание стоимости и качества для остекления балконов.
                </strong>{" "}
                Их свойства соответствуют всем требованиям пожаробезопасности и
                экологичности.
              </>,
              <>
                Они не окисляются, не скручиваются, не трескаются, устойчивы к
                деформации, коррозии, вредным действиям окружающей среды, имеют
                низкий удельный вес.{" "}
                <strong>
                  Долговечность таких конструкций составляет более 80 лет.
                </strong>
              </>,
            ],
            articlesAccordion: [],
            articleMedia: {
              imageSrc: provedal_2,
              imageCaption: (
                <>Холодное остекление балкона &quot;с плиты на плиту&quot;</>
              ),
              border: true,
            },
          },

          {
            ...
            articleParagraphsJSX: [
              <>
                Алюминиевые рамы не подпадают под действие ни одного ГОСТ. Из-за
                этого наш рынок наводнён низкокачественной продукцией.
              </>,
              <>
                <strong>
                  Главное отличие надёжной рамы &mdash; толщина стенок
                  алюминиевого профиля.
                </strong>
              </>,
              <>
                Настоящий алюминиевый профиль имеет толщину стенки &ndash; не
                менее 1мм, в нём также присутствуют все рёбра жесткости,
                предусмотренные авторами системы.
              </>,
              <>
                Цель использования тонкого профиля одна &ndash; сэкономить
                деньги на стоимости рамы, то есть предложить потребителю более
                низкую цену.
              </>,
              <>
              ...
              <>
                <strong>
                  Мы производим наши алюминиевые рамы на мощностях АО СОФОС
            ...
            articlesAccordion: [
              {
                accordionTitle: <>Для чего предназначен тонкий профиль?</>,
                accordionParagraphs: [
                  <>
                    Заводы выпускают облегчённый профиль для изготовления
                    маленьких рам. Например, он хорошо подходит для изготовления
                    шкафов-купе, окон раздачи в учреждениях питания и т.д.
                  </>,
                  <>
                    Однако, пользуясь тем, что потребитель не различает
                    полновесный профиль от низкосортного облегчённого, некоторые
                    монтажнные организации применяют его буквально везде.
                  </>,
                  <>
                    В итоге потребитель платит немного меньше изначально, но
                    через некоторое время сталкивается со всеми негативными
                    последствиями, которые невозможно устранить.
                  </>,
                ],
              },
            ],
