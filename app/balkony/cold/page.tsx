                ...
                articles={[
...

                    {
                        ...
                        articlesAccordion: [
                            {
                                accordionTitle: (
                                    <>Для чего предназначен тонкий профиль?</>
                                ),
                                accordionParagraphs: [
                                    <>
                                        Заводы выпускают облегчённый профиль для
                                        изготовления маленьких рам. Например, он
                                        хорошо подходит для изготовления
                                        шкафов-купе, окон раздачи в учреждениях
                                        питания и т.д.
                                    </>,
                                    <>
                                        Однако, пользуясь тем, что потребитель
                                        не различает полновесный профиль от
                                        низкосортного облегчённого, некоторые
                                        монтажнные организации применяют его
                                        буквально везде.
                                    </>,
                                    <>
                                        В итоге потребитель платит немного
                                        меньше изначально, но через некоторое
                                        время сталкивается со всеми негативными
                                        последствиями, которые невозможно
                                        устранить.
                                    </>,
                                ],
                            },
