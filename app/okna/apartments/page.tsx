                        ...
                        articlesAccordion: [
                            {
                                ...
                                accordionParagraphs: [
                                    <>
                                        &quot;Запотевание&quot; стекла - крайне
                                        вредный эффект. Вода стекает по стеклу
                                        на подоконник и приводит к образованию
                                        плесени на откосах.
                                    </>,
                                    <>
                                        Чем теплее внутренняя поверхность стекла
                                        - тем меньше вероятность возникновения
                                        конденсата. Нагреть стекло можно либо
                                        увеличив приток тёплого воздуха от
                                        радиатора, либо установив более
                                        &quot;тёплый&quot; стеклопакет.
                                    </>,
                                    <>
                                        Наш опыт показывает, что
                                        &quot;тёплый&quot; стеклопакет - отлично
                                        справляется с конденсатом, даже если
                                        отопление недостаточное.
                                    </>,
                                ],
                            },
                        ],
...

                    {
                        ...
                        articleParagraphsJSX: [
                            <>
                                ...
                                качества стали и защитного покрытия. Для
