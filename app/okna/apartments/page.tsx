...
import veka_euroline_1 from "@/public/images/veka_euroline_tmblr_1.jpg";
            ...
            >
                <Grid item xs={12}>
                    ...
                    <Typography gutterBottom>
                        ...
                        рекомендум три стекла для защиты от уличного шума, а
                        также с одним или двумя энергосберегающии покрытиями для
                    ...
                    <Typography gutterBottom>
                        ...
                        в средней полосе России довольно много пасмурных дней в
                        году и сохранение светового потока (инсоляции комнаты)
                        жизненно необходимо. Энергосберегающие покрытия
                        практически не уменьшают световой поток, поступающий
                        через окно. В то же время потери светового потока при
                        установке мультифункционального покрытия значительно
                        выше чем у энергосберегающего, поэтому в общем случая
                        его применение в квартире нецелесообразно.
                    </Typography>
                </Grid>
