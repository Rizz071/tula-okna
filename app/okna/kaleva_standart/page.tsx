...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: "https://тульские-окна.рф/okna/kaleva_standart/",
    },
};
    ...
    return (
        <>
            <HeaderSlider
                ...
                sliderImageAlt="Главный слайд: окна КАЛЕВА Стандарт"
                isCardVisible={false}
            />
                    ...
                    profilePage={{
                        ...
                        recommendedUse: [
                            ...
                            <>
                                ...
                                <br />
                                &emsp;•&emsp;квартир до 12 этажа включительно
                                <br />
                                &emsp;•&emsp;загородных домов эконом-класса
                                <br />
